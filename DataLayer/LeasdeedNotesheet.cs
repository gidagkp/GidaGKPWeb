...
namespace DataLayer
{
    ...
    public partial class LeasdeedNotesheet
    {
        ...
        public string Docname_Propassist { get; set; }
        public string Doctype_Propassist { get; set; }
        public string Comment_Propassist { get; set; }
        public byte[] Digsign_Manager { get; set; }
        public string Docname_Digsignmanager { get; set; }
        public string Doctype_Digsignmanager { get; set; }
        public string Comment_Manager { get; set; }
        public byte[] Digsign_FManager { get; set; }
        public string Docname_FManager { get; set; }
        public string Doctype_FManager { get; set; }
