...
namespace DataLayer
{
    ...
    public partial class LeaseRentDetail
    {
        public int Id { get; set; }
        public Nullable<int> ApplicationId { get; set; }
        public Nullable<int> UserId { get; set; }
        public Nullable<int> AllotmentId { get; set; }
        public Nullable<System.DateTime> LeaseRentDate { get; set; }
        public string LeaseInterestRate { get; set; }
        ...
        public Nullable<decimal> MaintainanceCharge { get; set; }
